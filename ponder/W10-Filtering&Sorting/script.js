console.log("hello")
//This was done outside of class so it will look a bit different
// Practtice Code - Sort
const simpleList = ["oranges", "grapes", "lemons", "apples", "Bananas", "watermelons", "coconuts", "broccoli", "mango"];
                
function compareFn(a,b) {
    //made it all lowercase
  a = a.toLowerCase();
  b = b.toLowerCase();
...
const wildAnimals = animals.filter(animal => animal.traits.includes("wild"))
...
//search code One Possible Solution from assignment
